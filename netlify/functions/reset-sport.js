...
const ADMIN_PASSWORD = "mktihavecpu"; 

// This is the "Fresh" data state you want to reset to.
// If you want to change prices later, edit them HERE.
const FRESH_DATA = {
  "exteriorLogo": {
    "name": "Exterior Logo",
...
export default async (req) => {
    ...
    try {
        ...
        await spotsStore.setJSON("spots-data", FRESH_DATA);
        
        return new Response("✅ Database Reset Successful! All spots are now Available.", { 
            status: 200,
